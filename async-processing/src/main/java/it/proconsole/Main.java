...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    var serialExecutionUseCase =
        new SerialExecutionUseCase(fastRepository, slowRepository, slowestRepository);
    var concurrentExecutionUseCase =
        new ConcurrentExecutionUseCase(fastRepository, slowRepository, slowestRepository);
